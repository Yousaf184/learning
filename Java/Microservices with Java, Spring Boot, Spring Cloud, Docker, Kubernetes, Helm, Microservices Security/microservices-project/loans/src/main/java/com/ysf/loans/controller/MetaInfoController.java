...
public class MetaInfoController {
    ...
    @Operation(
            ...
            description = "Endpoint for getting the build information that is deployed into loans microservice",
            responses = {
                    @ApiResponse(
                            responseCode = "200",
    ...
    @Operation(
            ...
            description = "Endpoint for getting the java version that is installed on the server running the loans microservice",
            responses = {
                    @ApiResponse(
                            responseCode = "200",
